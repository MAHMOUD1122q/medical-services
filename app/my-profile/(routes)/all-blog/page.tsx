...
export default function AllBlog() {
  ...
  useEffect(() => {
    fetch(
      `http://localhost:4000/api/blog/all-blog?page=${page}&limit=6`,
      {}
    ).then((response) => {
  ...
  const deleteBlog = async (id: any) => {
    const data = await fetch(
      `http://localhost:4000/api/blog/delete-blog/${id}`,
      {
        method: "DELETE",
        headers: {
