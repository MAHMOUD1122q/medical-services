      ...
      {admin ? (
        <>
          <ul className=" border-b-[1px]">
            ...
            <li
              className={`mb-2 cursor-pointer hover:text-sky-600 duration-300 ${
                pathname.endsWith("/add-medicen") ? "text-[#185a9d]" : ""
              }`}
          ...
          <ul className=" mt-2">
            <li className={`mb-2 cursor-pointer hover:text-sky-600 duration-300 ${
                pathname.endsWith("/my-profile") ? "text-sky-600" : ""
              }`} onClick={()=> router.push("/my-profile")}>My profile</li>
            <li className={`mb-2 cursor-pointer hover:text-sky-600 duration-300 ${
                pathname.endsWith("/update-password") ? "text-sky-600" : ""
              }`}  onClick={()=> router.push("/my-profile/update-password")}>Update password</li>
          </ul>
        </>
      ) : (
        <ul className=" mt-2">
